...
public class Cliente implements Serializable{
	...
	@JsonManagedReference  // Serializando os endereços para o ENDPOINT(ja no outro lado NÃO pode serializar o cliente)
	@OneToMany(mappedBy="cliente") //Um para muitos, que foi mapeado em ENDERECO pelo atributo "cliente"
